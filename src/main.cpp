...
//x86_64-w64-mingw32-g++ -std=c++17 main.cpp login.cpp utils.cpp key_derivation.cpp user_account_managing.cpp vault.cpp encryption.cpp -o password_manager -largon2 -lcryptopp
using namespace std;
